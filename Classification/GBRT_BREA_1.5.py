...
data = pd.read_csv(r"C:\Users\JQ\experiment\data\BREA\split\FC1.5FDR0.05\train_1.csv")
x_columns = []
...
data = pd.read_csv(r"C:\Users\JQ\experiment\data\BREA\split\FC1.5FDR0.05\valid_1.csv")
x_columns = []
for x in data.columns:
    if x not in ['label']:
        x_columns.append(x)
...
y_valid = data['label']
#
data = pd.read_csv(r"C:\Users\JQ\experiment\data\BREA\split\FC1.5FDR0.05\test_1.csv")
x_columns = []
for x in data.columns:
    if x not in ['label']:
        x_columns.append(x)
