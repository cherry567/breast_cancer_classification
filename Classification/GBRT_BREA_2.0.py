...
data = pd.read_csv(r"C:\Users\JQ\experiment\data\BREA\split\FC2.0FDR0.05\train_0.5.csv")
x_columns = []
...
data = pd.read_csv(r"C:\Users\JQ\experiment\data\BREA\split\FC2.0FDR0.05\valid_0.5.csv")
x_columns = []
for x in data.columns:
    if x not in ['label']:
        x_columns.append(x)
...
y_valid = data['label']
#
data = pd.read_csv(r"C:\Users\JQ\experiment\data\BREA\split\FC2.0FDR0.05\test_0.5.csv")
x_columns = []
for x in data.columns:
    if x not in ['label']:
        x_columns.append(x)
